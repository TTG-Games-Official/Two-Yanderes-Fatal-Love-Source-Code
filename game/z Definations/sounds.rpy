...
default current_dynamic_music = None
...
define island_meet = "<loop 0.0>audio/music/Incompetech/Island Meet and Greet.opus"
...
define scaryhorror_easteregg = "<loop 9.613>audio/music/Pixabay/Scary Horror Music Easter Egg.opus"
...
define schoolday_h_h = "<loop 0.0>audio/music/TTG Games/Schoolday/Schoolday High ATM High Sanity.opus"
define schoolday_h_m = "<loop 0.0>audio/music/TTG Games/Schoolday/Schoolday High ATM Medium Sanity.opus"
define schoolday_h_l = "<loop 0.0>audio/music/TTG Games/Schoolday/Schoolday High ATM Low Sanity.opus"
...
define echoesoflove_h_h = "<loop 0.0>audio/music/TTG Games/Echoes of Love/Echoes of Love High ATM High Sanity.opus"
define echoesoflove_h_m = "<loop 0.0>audio/music/TTG Games/Echoes of Love/Echoes of Love High ATM Medium Sanity.opus"
define echoesoflove_h_l = "<loop 0.0>audio/music/TTG Games/Echoes of Love/Echoes of Love High ATM Low Sanity.opus"
...
define evening_glow_h_h = "<loop 0.0>audio/music/TTG Games/Evening Glow/Evening Glow High ATM High Sanity.opus"
define evening_glow_h_m = "<loop 0.0>audio/music/TTG Games/Evening Glow/Evening Glow High ATM Medium Sanity.opus"
define evening_glow_h_l = "<loop 0.0>audio/music/TTG Games/Evening Glow/Evening Glow High ATM Low Sanity.opus"
define evening_glow_m_h = "<loop 0.0>audio/music/TTG Games/Evening Glow/Evening Glow Medium ATM High Sanity.opus"
define evening_glow_m_m = "<loop 0.0>audio/music/TTG Games/Evening Glow/Evening Glow Medium ATM Medium Sanity.opus"
define evening_glow_m_l = "<loop 0.0>audio/music/TTG Games/Evening Glow/Evening Glow Medium ATM Low Sanity.opus"
define evening_glow_l_h = "<loop 0.0>audio/music/TTG Games/Evening Glow/Evening Glow Low ATM High Sanity.opus"
define evening_glow_l_m = "<loop 0.0>audio/music/TTG Games/Evening Glow/Evening Glow Low ATM Medium Sanity.opus"
define evening_glow_l_l = "<loop 0.0>audio/music/TTG Games/Evening Glow/Evening Glow Low ATM Low Sanity.opus"
...
init python:
    ...
    def play_music(musicname, fadein=0):
        ...
        if musicname not in ("evening_glow", "schoolday", "echoes_of_love"):
            return

        current_dynamic_music = musicname
        ...
        if musicname == "evening_glow":
            ...
            if check_atm > 67:
                ...
                renpy.music.play(evening_glow_m_h, channel="hsanity", loop=True, fadein=fadein)
                renpy.music.play(evening_glow_m_m, channel="msanity", loop=True, fadein=fadein)
                renpy.music.play(evening_glow_m_l, channel="lsanity", loop=True, fadein=fadein)
            else:
                renpy.music.play(evening_glow_l_h, channel="hsanity", loop=True, fadein=fadein)
                renpy.music.play(evening_glow_l_m, channel="msanity", loop=True, fadein=fadein)
                renpy.music.play(evening_glow_l_l, channel="lsanity", loop=True, fadein=fadein)
    ...
    def restart_dynamic_music_after_load():

        if current_dynamic_music in ("evening_glow", "schoolday", "echoes_of_love"):
            play_music(current_dynamic_music, 0)
...
define item_drop = "audio/sfx/Pixabay/Item Drop.opus"
define spray = "audio/sfx/Pixabay/Spray.opus"
