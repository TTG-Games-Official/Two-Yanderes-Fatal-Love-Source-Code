...
# Idle movement of the character in the main menu during the easter egg.
transform akira_menu_easteregg:
    ...
    block:
        ease 2.5 xalign 0.35 - 0.01
        ease 2.5 xalign 0.35
        repeat
...
transform atm_shift_chr:
    ...
    linear 2 matrixcolor SaturationMatrix(1.0) * ContrastMatrix(1.0) * BrightnessMatrix(0.0)
...
# Chapter Selection Screen Transforms
