    ...
    use game_menu(_("                          CREDITS"), scroll="viewport"):
                ...
                vbox:
                    ...
                    vbox:
                        ...
                        vbox:
                            ...
                            text _("{color=#1E90FF}- {/color}{a=https://potat0master.itch.io/free-visual-novel-backgrounds-school-mini-pack-1}{color=#1E90FF}Potat0Master (Background){/a}{/color}") style "credits_item"
        ...
        if persistent.yandere_menu_enabled == "easteregg":
            ...
            vbox:
                ...
                text _("{size=38}(CC): ALL OF THE LOVE IN THIS GAME WAS COMPOSED BY ME\nAND LICENSED UNDER THE 'FOREVER YOURS' AGREEMENT.\nSEE THE 'OBSESSION' SECTION BELOW FOR ETERNAL DETAILS.")
                ...
                vbox:
                    ...
                    vbox:
                        ...
                        vbox:
                            ...
                            text _("- YOU") style "credits_item" ypos + 10
